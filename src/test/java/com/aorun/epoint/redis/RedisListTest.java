...
//
//
//import com.aorun.epoint.config.redis.Department;
//import com.aorun.epoint.config.redis.Role;
//import com.aorun.epoint.config.redis.User;
//import com.aorun.epoint.config.redis.UserRedis;
...
//        users.add(user);
//
//        String key = this.getClass().getName()+":userList:"+user.getName();
//        userRedis.delete(key);
//        userRedis.add(key, 10L, users);
//
//
//    }
//
